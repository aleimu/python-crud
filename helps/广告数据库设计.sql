...
CREATE TABLE `ad_ctr` (
    ...
    `show_day` varchar(124) DEFAULT NULL COMMENT '全天时段曝光量',
    `click_day` varchar(124) DEFAULT NULL COMMENT '全天时段点击量',
...
CREATE TABLE `ad_style` (
    ...
    `oper_uname` varchar(124) DEFAULT NULL COMMENT '操作人username',
